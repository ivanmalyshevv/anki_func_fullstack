...
def ask_and_check(word, correct):
    """
    Спрашивает у пользователя перевод слова, возвращает флаги выхода, правильности и время ответа.
    ...
    Returns:
        Tuple[bool, bool, float]: (нужен_выход, правильный_ли_ответ, время_ответа)
    """
...
def train_until_mistake(words):
    """
    Запускает режим "до первой ошибки": пользователь переводит слова до ошибки или выхода.
